...
export const CORE_AUTH_CHOICE_OPTIONS: ReadonlyArray<AuthChoiceOption> = [
  {
    value: "cli-proxy-api",
    label: "CLI Proxy API",
    hint: "Claude Code OAuth bridge (Anthropic-compatible)",
    groupId: "cli-proxy-api",
    groupLabel: "CLI Proxy API",
    groupHint: "Claude Code OAuth bridge (Anthropic-compatible)",
  },
  {
